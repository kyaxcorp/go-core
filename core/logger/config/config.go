...
type Config struct {
	...
	ModuleName string `yaml:"module_name" default:""`

	// Description -> something about it
	Description string

	EncodeLogsAsJson string `yaml:"encode_logs_as_json" default:"yes"`

	// CliIsEnabled -> If console logging is enabled
	ConsoleIsEnabled string `yaml:"console_is_enabled" default:"yes"`

	ConsoleTimeFormat string `yaml:"console_time_format" default:"002 15:04:05.000"`
