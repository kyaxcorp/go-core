...
type OnConnectOptions struct {
	RetryOnFailed string `yaml:"retry_on_failed" default:"yes"`
	...
	MaxNrOfRetries int8 `yaml:"retry_times_on_failed" default:"3"`
	// This is the delay between Total retries
	RetryDelaySeconds int8 `yaml:"retry_delay_seconds" default:"2"`
	...
	OnFailedDelayDurationBetweenConnections time.Duration `yaml:"on_failed_delay_duration_between_connections" default:"0"`

	PanicOnFailed string `yaml:"panic_on_failed" default:"no"`
}
